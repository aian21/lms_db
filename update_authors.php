...
$authorID = $con->updateAuthors($authorfirst, $authorlast, $authorbday, $authornat, $id);
...
<div class="container my-5 border border-2 rounded-3 shadow p-4 bg-light">
  ...
  <h4 class="mt-5">Update Existing Authors</h4>
    ...
    <button type="submit" name="update" class="btn btn-primary">Add Author</button>
  </form>
